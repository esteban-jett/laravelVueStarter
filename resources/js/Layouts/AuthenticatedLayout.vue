...
const isSmallScreen = ref(window.innerWidth < 640); // Example breakpoint for small screens
        ...
        <div :class="{ 'ml-0 sm:ml-0': !isSmallScreen }" class="flex-1 min-h-screen bg-gray-100 dark:bg-gray-100 transition-all duration-300">
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }" class="sm:hidden">
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('website')" :active="route().current('website')">Website</ResponsiveNavLink>
                    </div>

                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('chats')" :active="route().current('chats')">Chats</ResponsiveNavLink>
                    </div>

                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('inventory')" :active="route().current('inventory')">Inventory</ResponsiveNavLink>
                    </div>
